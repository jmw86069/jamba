...
```{r, log_ticks_1, fig.show='hold', fig.alt="Example showing various forms of log tick axis labels."}
...
```{r, log_fc_ticks, fig.show='hold', fig.alt="Example showing log fold change ticks, using log2 scale with positive and negative values."}
